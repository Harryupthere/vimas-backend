...
export class CreatePointSystemTables1784389819472
  implements MigrationInterface
{
  name = 'CreatePointSystemTables1784389819472';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS point_distributions (
          ...
          event_type ENUM(
              'BUY_PRODUCT', 'SELL_PRODUCT', 'REFERRAL', 'POOL_DISTRIBUTION',
              'ADMIN_ADJUSTMENT', 'BONUS', 'REFUND', 'OTHER'
          ) NOT NULL,
          receiver_type ENUM(
              'BUYER', 'MERCHANT', 'UPLINE_LEVEL_1', 'UPLINE_LEVEL_2', 'POOL', 'ADMIN'
          ) NOT NULL,
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS point_user_balances (
          id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS point_admin_balances (
          id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS point_pool_details (
          id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
          type ENUM(
              'hourly', 'daily', 'weekly', 'monthly', 'quarterly', 'half_yearly', 'yearly'
          ) NOT NULL,
          name VARCHAR(100) NOT NULL,
          description TEXT,
          symbol VARCHAR(30),
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS point_pools (
          ...
          FOREIGN KEY(pool_detail_id) REFERENCES point_pool_details(id)
      )
    `);
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS point_transactions (
          id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
          wallet_type ENUM('USER','ADMIN','POOL') NOT NULL,
          wallet_id BIGINT UNSIGNED NOT NULL,
          transaction_type ENUM('CREDIT','DEBIT') NOT NULL,
          transaction_reason ENUM(
              'BUY_PRODUCT', 'SELL_PRODUCT', 'PURCHASE_REWARD', 'REFERRAL_LEVEL_1',
              'REFERRAL_LEVEL_2', 'POOL_CONTRIBUTION', 'POOL_DISTRIBUTION',
              'PRODUCT_PURCHASE', 'ADMIN_ADJUSTMENT', 'BONUS', 'REFUND', 'EXPIRE', 'OTHER'
          ) NOT NULL,
          ...
          FOREIGN KEY(point_distribution_id) REFERENCES point_distributions(id),
          CONSTRAINT fk_transaction_pool
          FOREIGN KEY(pool_id) REFERENCES point_pools(id)
      )
    `);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS point_pools`);
    await queryRunner.query(`DROP TABLE IF EXISTS point_pool_details`);
    await queryRunner.query(`DROP TABLE IF EXISTS point_admin_balances`);
    await queryRunner.query(`DROP TABLE IF EXISTS point_user_balances`);
    await queryRunner.query(`DROP TABLE IF EXISTS point_distributions`);
  }
}
